<template>
  <div class="leftSideBar__body">
    ...
    <ul class="menu">
      <li class="menu__item" :class="{ active: currentRoutePath === '/' }">
      ...
      <li
        class="menu__item"
        :class="{ active: currentRoutePath === '/search' }"
      >
      ...
      <li
        class="menu__item"
        :class="{ active: currentRoutePath === '/collection' }"
      >
        <router-link tag="a" to="/collection">
          <svg
            role="img"
            height="24"
            width="24"
    ...
    <ul class="playlist-menu">
      <li class="playlist-menu__item">
        <router-link tag="a" to="/">
          <div class="playlist-menu__item-icon">
            <svg
              role="img"
              height="12"
              width="12"
    ...
    <ul class="playlist">
      <li
        ...
        :class="{ active: currentRoutePath === `/playlist/${item.id}` }"
      >
        <router-link tag="a" :to="'/playlist/' + item.id">
          {{ item.name }}
        </router-link>
      </li>
    </ul>
